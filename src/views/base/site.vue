      ...
      <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" class="diatable">
        <el-form class="small-space" :model="temp2" label-position="left" label-width="90px" style='width: 500px; margin-left:20px;'>
          ...
          <el-form-item label="服务站名称">
            <el-input :maxlength="15" :minlength="2" style='width: 400px;' v-model="temp2.stationName" placeholder="请输入2-15位的服务站名称"></el-input>
          </el-form-item>
          ...
          <el-form-item label="详细地址">
            <el-input :maxlength="100" :minlength="6" style='width: 400px;' v-model="temp2.addr" placeholder="请输入6-100位的详细地址"></el-input>
          </el-form-item>

          <el-form-item label="服务站电话">
            <el-input style='width: 400px;' v-model="temp2.phone" placeholder="可选格式：11位手机号、座机（区号-电话号码）"></el-input>
          </el-form-item>
